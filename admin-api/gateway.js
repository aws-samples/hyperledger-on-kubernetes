...
async function getProfiles(configtxPath) {
    ...
    try {
        ...
        for (let profile in configtx['Profiles']) {
            logger.info("Profiles in this network are: " + configtx['Profiles'][profile] + " with orgs: " + Object.getOwnPropertyNames(configtx['Profiles'][profile]['Application']['Organizations']));
